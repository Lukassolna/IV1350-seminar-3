...
/**
 * Constructs a new ExternalAccountingSystem object and initializes an empty list of sales.
 */
...
/**
 * Updates the accounting system with the provided Sale object by adding it to the list of all sales.
