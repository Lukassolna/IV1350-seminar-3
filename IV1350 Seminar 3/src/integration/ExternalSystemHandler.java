...
/**
 * A class that handles interactions with external systems, such as the discount database,
...
public class ExternalSystemHandler {
    ...
    /**
     * Creates a new instance of ExternalSystemHandler with initialized instances of the
     * DiscountDatabase, ExternalAccountingSystem, and ExternalInventorySystem classes.
     */
    ...
    /**
     * Returns the DiscountDatabase instance associated with this ExternalSystemHandler.
     *
    ...
    /**
     * Returns the ExternalAccountingSystem instance associated with this ExternalSystemHandler.
     *
    ...
    /**
     * Returns the ExternalInventorySystem instance associated with this ExternalSystemHandler.
     *
    ...
    /**
     * Updates the external systems (external inventory system and external accounting system)
     * with the given sale information.
     *
